      ...
      <div className="field-content container-full px-6 lg:px-12 grid lg:grid-cols-[1.15fr_1fr] gap-12 lg:gap-20 items-center">
        <div className="max-w-[720px]">
          ...
          <Reveal as="h1" delay={80} className="t-display balance mb-7">
            ...
            <br />
            <span className="accent-text italic font-normal">With AI you can actually trust.</span>
          </Reveal>

          <Reveal as="p" delay={160} className="t-lead pretty mb-10 max-w-[54ch]">
            You&rsquo;re not short on tools. You&rsquo;re short on the right
            ones: built around your operation, kept private, standing on more
            than a clever prompt.{" "}
            <span className="text-[color:var(--color-ink)]">
              We build automation that frees your time, and a private AI vault
          ...
          <Reveal as="div" delay={240} className="flex flex-wrap items-center gap-3">
            ...
            <a href="/services" className="btn btn-glass text-[14px]">
              See what we build →
            </a>
          </Reveal>
        </div>
      ...
      <div className="field-content container-wide grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
        <div>
          ...
          <Reveal as="h2" delay={80} className="t-display-md balance mb-7">
            You have tried{" "}
            <span className="italic font-normal accent-text">everything.</span>
            <br />
            It keeps coming back.
          </Reveal>
          <Reveal as="p" delay={160} className="t-lead pretty mb-10 max-w-[50ch]">
            New strategy, new hire, new tool. Six months later you&rsquo;re back
            where you started.{" "}
            <span className="text-[color:var(--color-on-dark)]">
              That is not a strategy problem. It is a root problem.
            </span>
          </Reveal>
          ...
          <ul className="flex flex-col">
            {symptoms.map((q, i) => (
              ...
              >
                <Reveal as="span" delay={i * 60} className="block">
          ...
          <Reveal as="div" delay={120}>
            <GlassCard className="p-8 lg:p-10">
              ...
              <p className="text-[22px] sm:text-[26px] lg:text-[30px] leading-[1.3] tracking-[-0.018em] text-[color:var(--color-on-dark)] font-medium">
                Most AI tools treat the symptom: a faster reply, another agent
                on the pile.{" "}
                <span className="text-[color:var(--color-on-dark-muted)] italic font-normal">
                  The real problem sits one layer down.
                </span>{" "}
                Your operation depending on you, your knowledge trapped in your
                head, your time eaten by the same tasks every week.
              </p>
            </GlassCard>
          </Reveal>

          <Reveal as="p" delay={220} className="t-body mt-8 max-w-[46ch]">
            We solve at that layer.{" "}
            <span className="text-[color:var(--color-on-dark)]">
              Automation that handles what doesn&rsquo;t need you, and a private
              vault that holds the intelligence your business runs on.
            </span>{" "}
...
function WhatItIs() {
  ...
  return (
    <section id="platform" className="surface-parchment section relative overflow-hidden">
      <Backdrop tone="light" />
      <div className="field-content container-wide">
        <div className="max-w-[820px]">
          ...
          <Reveal as="h2" delay={80} className="t-display-md balance mb-7">
            Not another tool.{" "}
            <span className="accent-text italic font-normal">The certainty it gets solved.</span>
          </Reveal>
          <Reveal as="p" delay={160} className="t-lead pretty max-w-[58ch] mb-4">
            People don&rsquo;t want AI. They want their time back and their
            business running without them.
          </Reveal>
      ...
      <div className="field-content container-wide">
        <div className="max-w-[760px] mb-12 lg:mb-16">
          ...
          <Reveal as="h2" delay={80} className="t-display-md balance">
            Two offerings.{" "}
            <span className="accent-text italic font-normal">One protocol underneath.</span>
          </Reveal>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-5 lg:gap-6">
          {cards.map((c, i) => (
            ...
            >
              ...
              <p className="t-body mb-8 max-w-[46ch] flex-1">{c.body}</p>
        ...
        <Reveal as="p" delay={160} className="t-body italic text-center max-w-[60ch] mx-auto mt-12">
          Automation gives you time back. The Vault gives you intelligence that
          compounds.{" "}
          <span className="accent-text">
            Together they&rsquo;re a complete AI journey, not a stack of
            disconnected tools.
          </span>
        </Reveal>
      </div>
...
function ForYou() {
  return (
    <section id="for-you" className="surface-canvas section relative overflow-hidden">
      <Backdrop tone="light" />
      <div className="field-content container-wide">
...
function Platform() {
  ...
  return (
    <section data-on-dark className="surface-ink section relative overflow-hidden">
      <Backdrop tone="dark" />
      <div className="field-content container-wide grid lg:grid-cols-[1fr_1.1fr] gap-12 lg:gap-24 items-start">
        <div className="lg:sticky lg:top-32">
          ...
          <Reveal as="h2" delay={80} className="t-display-md balance mb-7">
            ...
            <br />
            <span className="accent-text italic font-normal">
              Every context it shows up in.
            </span>
          </Reveal>
          <Reveal as="p" delay={160} className="t-lead pretty max-w-[44ch] mb-8">
            AI Merge reads your story and your patterns, finds the root, then
            delivers a protocol calibrated to your industry and your life.
          </Reveal>
        ...
        <div className="flex flex-col">
          {products.map((p, i) => (
            <Reveal
              ...
              key={p.tag}
              delay={i * 80}
              className="group border-t border-[color:var(--color-hairline-dark)] last:border-b py-7 grid grid-cols-[88px_1fr_24px] gap-5 items-start cursor-pointer"
            >
...
function Industries() {
  const tiles = [
    { src: ASSETS.industry1, label: "Real Estate", body: "Coherence at scale for brokerages and firms." },
    { src: ASSETS.industry2, label: "Finance", body: "Decisions under pressure, regulated by clarity." },
    { src: ASSETS.industry3, label: "Healthcare", body: "Care teams that hold without burning out." },
    { src: ASSETS.industry4, label: "Communities", body: "Belonging that compounds across generations." },
  ];
  return (
        ...
        <div className="flex items-end justify-between flex-wrap gap-6 mb-12 lg:mb-16">
          <div className="max-w-[640px]">
            ...
            <Reveal as="h2" delay={80} className="t-display-md balance">
              ...
              <span className="accent-text italic font-normal">your field.</span>
            </Reveal>
          </div>
...
function Proof() {
  ...
  return (
    <section id="proof" className="surface-canvas section relative overflow-hidden">
      <Backdrop tone="light" />
      <div className="field-content container-wide">
        <div className="text-center max-w-[760px] mx-auto mb-12 lg:mb-16">
          <Reveal as="p" className="t-eyebrow mb-5">
          ...
          {proofs.map((p, i) => (
            ...
            >
              <blockquote className="text-[18px] leading-[1.5] tracking-[-0.012em] text-[color:var(--color-ink)] mb-7 flex-1">
                <span aria-hidden className="text-[color:var(--color-accent)] mr-1">“</span>
                {p.text}
                <span aria-hidden className="text-[color:var(--color-accent)] ml-1">”</span>
              </blockquote>
...
function Founder() {
  return (
    <section id="founder" className="surface-canvas section relative overflow-hidden">
      <Backdrop tone="light" />
      <div className="field-content container-wide grid lg:grid-cols-[1fr_1.1fr] gap-12 lg:gap-20 items-center">
        <Reveal as="div" className="order-2 lg:order-1">
          ...
          <p className="t-lead pretty mb-6 max-w-[52ch]">
            Manuj Aggarwal: four AI patents, three decades in technology, and a
            lifelong investigator of why human systems get stuck. AI Merge
            converges his engineering and clinical research, published in the
    ...
    <section data-on-dark className="surface-ink section relative overflow-hidden">
      ...
      <div className="field-content relative container-tight text-center">
        ...
        <Reveal as="p" delay={80} className="t-lead pretty mb-8">
          Most AI work stops at the tool: another agent, another prompt, another
          integration.{" "}
          <span className="text-[color:var(--color-on-dark)]">
            That is the easy half. It is also where almost everyone gets stuck.
          </span>
        </Reveal>
        <Reveal as="p" delay={160} className="t-lead pretty mb-12">
          We build the whole thing: the automation, the private vault, and the{" "}
          <span className="accent-text italic">human layer</span> that ties
          them together. The work compounds instead of decaying.
        </Reveal>
        ...
        <Reveal as="div" delay={240} className="flex justify-center">
          <GlassCard className="inline-block px-10 py-8">
            ...
            <p className="font-mono text-[10px] tracking-[0.2em] uppercase text-[color:var(--color-on-dark-faint)]">
              Peer-reviewed · Mensa Research Journal · Vancouver, Canada
            </p>
          </GlassCard>
        </Reveal>
      </div>
...
function CTA() {
  return (
    <section id="score" className="surface-parchment section relative overflow-hidden">
      <Backdrop tone="light" parallax />
      <div className="field-content container-tight">
        <GlassCard className="text-center px-6 sm:px-12 py-14 lg:py-20" interactive={false}>
          ...
          <Reveal as="h2" delay={80} className="t-display balance mb-7">
            ...
            <br />
            in the{" "}
            <span className="accent-text italic font-normal">age of AI?</span>
          </Reveal>
          <Reveal as="p" delay={160} className="t-lead pretty max-w-[52ch] mx-auto mb-10">
            See exactly where you stand, and the root patterns holding you back.
          </Reveal>
