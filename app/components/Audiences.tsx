...
const AUDIENCES: Audience[] = [
    ...
    {
        id: "communities",
        image: "/people/image.jpg",
        imageAlt:
            "A community member seated calmly in a warm office space, looking at the camera.",
        tab: "Communities",
        ...
        body: (
            <>
                In civic institutions, firms, and congregations, the root
                patterns in the collective determine what can be held and
                transmitted. AI Merge reads the collective nervous system and
                cultivates what it needs to thrive.
            </>
        ),
        outcomes: [
        ...
        <div>
            ...
            >
                ...
                >
                    ...
                    <h3 className="t-display-md balance mb-6">
                        {current.title}
                    </h3>
                    <p className="t-lead pretty mb-8 max-w-[52ch]">
                        {current.body}
                    </p>
                    <ul className="flex flex-col gap-3 mb-10">
                        {current.outcomes.map((o) => (
                            <li
                                key={o}
                                className="flex gap-3 t-body !text-[color:var(--color-body)]"
                            >
                                <span
                                    aria-hidden
                    ...
                    <div className="absolute inset-x-3 bottom-3 sm:inset-x-4 sm:bottom-4">
                        <GlassCard interactive={false} className="p-5 sm:p-6">
                            <blockquote className="text-[16px] sm:text-[18px] leading-[1.45] tracking-[-0.012em] text-[color:var(--color-on-dark)]">
                                <span
                                    aria-hidden
                                    className="text-[color:var(--color-accent-sky)] mr-1"
                                >
                                    “
                                </span>
                                {current.quote.text}
                                <span
                                    aria-hidden
                                    className="text-[color:var(--color-accent-sky)] ml-1"
                                >
                                    ”
                                </span>
                            </blockquote>
